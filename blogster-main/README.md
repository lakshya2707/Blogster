# Blogster
Blogster is a modern blogging application inspired by platforms like Medium, designed to empower users to share their ideas and stories with the world. 
...
npm install
```
2. Create a `.env` and `wrangler.toml` file inside backend.
